...
<template>
  <div class="min-h-screen bg-cream">
   ...
   <ImageTextSection
      ...
      buttonText="Découvrir le fonctionnement"
      ...
      imageAlt="Illustration MatchRoom"
      imagePosition="left"
    />
    ...
    <ImageTextSection
      ...
      imageSrc="https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
      imageAlt="Offres spéciales"
      imagePosition="right"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="bg-colonial-white-light rounded-xl p-8 shadow-md">
            <div class="flex justify-center mb-4">
              <div class="rounded-full w-24 h-24 bg-white/50 overflow-hidden flex items-center justify-center">
                <img src="https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&auto=format&fit=crop&q=80" alt="Avatar" class="w-full h-full object-cover" />
              </div>
            </div>
            ...
            <div class="flex justify-center mb-3">
              <div class="flex space-x-1">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#F5E0A0" class="w-5 h-5">
                  <path fill-rule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clip-rule="evenodd" />
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#F5E0A0" class="w-5 h-5">
                  <path fill-rule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clip-rule="evenodd" />
          ...
          <div class="bg-colonial-white-light rounded-xl p-8 shadow-md">
            <div class="flex justify-center mb-4">
              <div class="rounded-full w-24 h-24 bg-white/50 overflow-hidden flex items-center justify-center">
                <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&q=80" alt="Avatar" class="w-full h-full object-cover" />
              </div>
            </div>
          ...
          <div class="bg-colonial-white-light rounded-xl p-8 shadow-md">
            <div class="flex justify-center mb-4">
              <div class="rounded-full w-24 h-24 bg-white/50 overflow-hidden flex items-center justify-center">
                <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&auto=format&fit=crop&q=80" alt="Avatar" class="w-full h-full object-cover" />
              </div>
            </div>
            ...
            <p class="text-sm text-quincy text-center">
              MatchRoom a révolutionné ma façon de réserver des hôtels. Après plusieurs utilisations, je ne voyage plus sans consulter leurs offres. J'ai pu séjourner dans un boutique hôtel à Lyon qui était normalement hors de mon budget. Service client réactif et professionnel.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="py-16 bg-cream">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-quincy text-center mb-12 max-w-3xl mx-auto">
          Vous avez des questions sur notre service ? Consultez nos réponses aux questions les plus fréquentes.<br>
        ...
        <div class="">
          ...
          <div class="mb-4">
            <details class="group">
              <summary class="flex justify-between items-center bg-hawkes-blue p-6 rounded-xl cursor-pointer">
                <h4 class="text-xl font-semibold text-quincy">Comment fonctionne le système d'enchères de MatchRoom ?</h4>
                <span class="bg-white rounded-full w-8 h-8 flex items-center justify-center group-open:rotate-45 transition-transform">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-everglade">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                  </svg>
                </span>
              </summary>
              <div class="p-6 bg-white rounded-b-xl shadow-sm text-quincy">
                <p>Notre système d'enchères inversées permet aux voyageurs de proposer le prix qu'ils sont prêts à payer pour une chambre. Contrairement aux enchères traditionnelles, vous ne surenchérissez pas contre d'autres utilisateurs.</p>
                ...
                <p class="mt-3">Ce système vous permet de bénéficier de tarifs avantageux tout en offrant aux hôteliers la flexibilité d'optimiser leur taux d'occupation.</p>
              </div>
            </details>
          </div>
          ...
          <div class="mb-4">
            <details class="group">
              <summary class="flex justify-between items-center bg-hawkes-blue p-6 rounded-xl cursor-pointer">
                <h4 class="text-xl font-semibold text-quincy">Quelles garanties ai-je sur la qualité des établissements partenaires ?</h4>
                <span class="bg-white rounded-full w-8 h-8 flex items-center justify-center group-open:rotate-45 transition-transform">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-everglade">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                  </svg>
              ...
              <div class="p-6 bg-white rounded-b-xl shadow-sm text-quincy">
                <p>Chez MatchRoom, nous sommes intransigeants sur la qualité des établissements avec lesquels nous collaborons. Notre processus de sélection rigoureux garantit que tous nos partenaires répondent à des standards élevés.</p>
                ...
                <p class="mt-3">De plus, notre système de notation interne et les avis vérifiés de nos utilisateurs vous permettent de faire votre choix en toute confiance. Si vous rencontrez le moindre problème, notre service client est disponible 24/7 pour vous accompagner.</p>
              </div>
            </details>
          </div>
          ...
          <div class="mb-4">
            <details class="group">
              <summary class="flex justify-between items-center bg-hawkes-blue p-6 rounded-xl cursor-pointer">
                <h4 class="text-xl font-semibold text-quincy">Est-il possible d'annuler une réservation effectuée via MatchRoom ?</h4>
                <span class="bg-white rounded-full w-8 h-8 flex items-center justify-center group-open:rotate-45 transition-transform">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-everglade">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                  </svg>
              ...
              <div class="p-6 bg-white rounded-b-xl shadow-sm text-quincy">
                <p>Oui, MatchRoom offre des conditions d'annulation flexibles qui s'adaptent aux besoins des voyageurs modernes. Nous comprenons que les plans peuvent changer et nous avons conçu notre politique d'annulation pour vous offrir un maximum de flexibilité.</p>
                <p class="mt-3">Nos conditions d'annulation varient selon les établissements :</p>
                <ul class="list-disc pl-5 mt-2 space-y-2">
                  <li><strong>Flexibles</strong> : Annulation gratuite jusqu'à 24h avant l'arrivée</li>
                  <li><strong>Standards</strong> : Annulation gratuite jusqu'à 7 jours avant l'arrivée</li>
                  <li><strong>Restrictives</strong> : Annulation gratuite jusqu'à 14 jours avant l'arrivée</li>
                </ul>
                <p class="mt-3">Les conditions spécifiques sont clairement indiquées avant la finalisation de votre offre. En cas d'imprévu majeur (maladie, grève des transports, etc.), notre service client étudiera votre situation avec bienveillance, même hors des délais standards.</p>
                <p class="mt-3">Nous proposons également une assurance annulation premium qui vous permet d'annuler sans justificatif jusqu'à 24h avant votre séjour, quelle que soit la politique de l'établissement.</p>
              </div>
            </details>
          </div>
        </div>
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div class="md:col-span-1">
            ...
            <ul class="space-y-2 text-quincy-light text-sm">
              <li><a href="#" class="hover:text-burning-orange transition">Blog et conseils voyage</a></li>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="flex space-x-4">
            <a href="#" class="w-10 h-10 rounded-full bg-white flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#26422A" viewBox="0 0 24 24">
