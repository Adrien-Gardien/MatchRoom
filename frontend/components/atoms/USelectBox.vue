        ...
        >
            <div class="flex items-center gap-2 flex-1 overflow-hidden">
                <component 
                    :is="icon" 
                    v-if="icon" 
                    class="flex-shrink-0 size-5 text-tertiary"
                />
                <div class="text-ellipsis overflow-hidden whitespace-nowrap" :class="{ 'text-placeholder': !selectedOptions || (Array.isArray(selectedOptions) && selectedOptions.length === 0) }">
                    {{ displayValue }}
                </div>
            </div>
                ...
                <div class="py-1 max-h-60 overflow-y-auto">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <component :is="option.icon" v-if="option.icon" class="size-4 text-fg-quaternary group-hover:text-fg-quaternary-hover" />
                                {{ option.label }}
