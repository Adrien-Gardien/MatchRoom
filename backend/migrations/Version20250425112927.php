 ...
 */
final class Version20250425112927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE hotel (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, description TEXT NOT NULL, image VARCHAR(255) NOT NULL, ambiance VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE offer (id SERIAL NOT NULL, user_id_id INT DEFAULT NULL, room_id_id INT DEFAULT NULL, parent_offer_id INT DEFAULT NULL, proposed_price NUMERIC(10, 2) NOT NULL, status VARCHAR(255) NOT NULL, offer_date DATE NOT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_29D6873ECC0BD83F ON offer (parent_offer_id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE room (id SERIAL NOT NULL, hotel_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, price_per_night NUMERIC(10, 2) NOT NULL, capacity INT NOT NULL, image VARCHAR(255) DEFAULT NULL, service JSON DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE offer ADD CONSTRAINT FK_29D6873ECC0BD83F FOREIGN KEY (parent_offer_id) REFERENCES offer (id) NOT DEFERRABLE INITIALLY IMMEDIATE
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE offer DROP CONSTRAINT FK_29D6873ECC0BD83F
        SQL);
        $this->addSql(<<<'SQL'
